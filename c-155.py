...
diconary = {'Mutable':'Values can be changed just like a list',
...
def mutable():
    label_of_mutable['text'] = diconary['Mutable']

def immutable():
    label_of_immutable['text'] = diconary['Immutable']
    
def tkinter():
    label_of_tkinter['text'] = diconary['Tkinter']
